...
- pure hosted GitHub App contract helpers and tests for webhook intake order, webhook verification, installation token scoping, durable scan queue idempotency, compact reports, retention limits, uninstall cleanup, repeated cleanup idempotency, and scoped deletion planning
...
- Open hosted MVP roadmap issue: #29 hosted operational release gate.

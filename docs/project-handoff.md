...
- hosted pre-implementation contracts document and pure helpers for queue-safe pull request event parsing from trusted GitHub event fields
...
- #19 `Roadmap: define hosted webhook event parser contract`

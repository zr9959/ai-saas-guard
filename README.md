...
| Cloudflare hosted ingress | Deployed at `https://ai-saas-guard-hosted.zr9959.workers.dev` for signed GitHub webhook intake, KV queueing, installation-token exchange, PR file risk classification, and compact Check Run publishing; full source scan workers are still gated |
